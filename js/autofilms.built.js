...
return}for(g=0;g<j.length;g++){d(h,j[g])}}},{"./className/add":54,"@marcom/ac-polyfills/Array/prototype.slice":103,"@marcom/ac-polyfills/Element/prototype.classList":105}],54:[function(b,c,a){var d=b("./contains");
...
return}for(g=0;g<j.length;g++){b(h,j[g])}}},{"./className/remove":57,"@marcom/ac-polyfills/Array/prototype.slice":103,"@marcom/ac-polyfills/Element/prototype.classList":105}],59:[function(b,c,a){arguments[4][11][0].apply(a,arguments)
...
return g}f.prototype=window.Event.prototype;return f}())}}},{}],105:[function(b,c,a){
...
}else{return d.call(this,h)}}}f=null}())}}},{}],106:[function(b,c,a){if(typeof Object.assign!="function"){Object.assign=function(h){if(h==null){throw new TypeError("Cannot convert undefined or null to object")
...
}}}}return h}}},{}],107:[function(b,c,a){arguments[4][13][0].apply(a,arguments)
},{dup:13}],108:[function(b,c,a){arguments[4][14][0].apply(a,arguments)},{dup:14}],109:[function(b,c,a){arguments[4][15][0].apply(a,arguments)
},{dup:15}],110:[function(b,c,a){arguments[4][16][0].apply(a,arguments)},{dup:16}],111:[function(b,c,a){arguments[4][17][0].apply(a,arguments)
},{dup:17}],112:[function(b,c,a){arguments[4][18][0].apply(a,arguments)},{"../isNode":116,dup:18}],113:[function(b,c,a){arguments[4][19][0].apply(a,arguments)
},{"../COMMENT_NODE":107,"../DOCUMENT_FRAGMENT_NODE":108,"../ELEMENT_NODE":110,"../TEXT_NODE":111,"./isNodeType":112,dup:19}],114:[function(b,c,a){arguments[4][20][0].apply(a,arguments)
},{"./DOCUMENT_FRAGMENT_NODE":108,"./internal/isNodeType":112,dup:20}],115:[function(b,c,a){arguments[4][21][0].apply(a,arguments)
},{"./ELEMENT_NODE":110,"./internal/isNodeType":112,dup:21}],116:[function(b,c,a){arguments[4][22][0].apply(a,arguments)
},{dup:22}],117:[function(b,c,a){arguments[4][23][0].apply(a,arguments)},{"./internal/validate":113,dup:23}],118:[function(b,c,a){c.exports=window.Element?(function(d){return d.matches||d.matchesSelector||d.webkitMatchesSelector||d.mozMatchesSelector||d.msMatchesSelector||d.oMatchesSelector
}(Element.prototype)):null},{}],119:[function(b,c,a){arguments[4][24][0].apply(a,arguments)
},{"@marcom/ac-dom-nodes/COMMENT_NODE":107,"@marcom/ac-dom-nodes/DOCUMENT_FRAGMENT_NODE":108,"@marcom/ac-dom-nodes/DOCUMENT_NODE":109,"@marcom/ac-dom-nodes/ELEMENT_NODE":110,"@marcom/ac-dom-nodes/TEXT_NODE":111,"@marcom/ac-dom-nodes/isNode":116,"@marcom/ac-polyfills/Array/prototype.indexOf":102,dup:24}],120:[function(d,f,c){var g=d("@marcom/ac-dom-nodes/isElement");
...
}if(!a){return h(k,j)}return a.call(k,j)}},{"./internal/nativeMatches":118,"./internal/validate":119,"./shims/matchesSelector":122,"@marcom/ac-dom-nodes/isElement":115}],121:[function(b,c,a){arguments[4][25][0].apply(a,arguments)
},{"./internal/validate":119,"./shims/querySelectorAll":123,"@marcom/ac-polyfills/Array/prototype.slice":103,dup:25}],122:[function(c,d,b){var f=c("../querySelectorAll");
d.exports=function a(l,g){var k=l.parentNode||document;var h=f(g,k);var j;for(j=0;
j<h.length;j++){if(h[j]===l){return true}}return false}},{"../querySelectorAll":121}],123:[function(b,c,a){arguments[4][26][0].apply(a,arguments)
},{"@marcom/ac-dom-nodes/isDocumentFragment":114,"@marcom/ac-dom-nodes/isElement":115,"@marcom/ac-dom-nodes/remove":117,"@marcom/ac-polyfills/Array/prototype.indexOf":102,dup:26}],124:[function(b,c,a){c.exports.EventEmitter=b("./ac-event-emitter/EventEmitter")
},{"./ac-event-emitter/EventEmitter":125}],125:[function(d,c,f){var h="EventEmitter:propagation";
...
}};b.exports=h},{"./DOMEmitterEvent":128,"@marcom/ac-dom-events/addEventListener":129,"@marcom/ac-dom-events/dispatchEvent":130,"@marcom/ac-dom-events/removeEventListener":138,"@marcom/ac-dom-traversal/matchesSelector":120,"@marcom/ac-dom-traversal/querySelectorAll":121,"ac-event-emitter":124}],128:[function(b,c,a){var f={preventDefault:b("@marcom/ac-dom-events/preventDefault"),stopPropagation:b("@marcom/ac-dom-events/stopPropagation"),target:b("@marcom/ac-dom-events/target")};
...
}return false};c.exports=g},{"@marcom/ac-dom-events/preventDefault":137,"@marcom/ac-dom-events/stopPropagation":141,"@marcom/ac-dom-events/target":142}],129:[function(b,c,a){arguments[4][3][0].apply(a,arguments)
},{"./shared/getEventType":139,"./utils/addEventListener":143,dup:3}],130:[function(d,f,c){var a=d("./utils/dispatchEvent");
var b=d("./shared/getEventType");f.exports=function g(j,i,h){i=b(j,i);return a(j,i,h)
}},{"./shared/getEventType":139,"./utils/dispatchEvent":144}],131:[function(b,c,a){c.exports={addEventListener:b("./addEventListener"),dispatchEvent:b("./dispatchEvent"),preventDefault:b("./preventDefault"),removeEventListener:b("./removeEventListener"),stop:b("./stop"),stopPropagation:b("./stopPropagation"),target:b("./target")}
},{"./addEventListener":129,"./dispatchEvent":130,"./preventDefault":137,"./removeEventListener":138,"./stop":140,"./stopPropagation":141,"./target":142}],132:[function(b,c,a){arguments[4][4][0].apply(a,arguments)
},{"./shared/camelCasedEventTypes":133,"./shared/prefixHelper":134,"./shared/windowFallbackEventTypes":135,"./utils/eventTypeAvailable":136,dup:4}],133:[function(b,c,a){arguments[4][5][0].apply(a,arguments)
},{dup:5}],134:[function(b,c,a){arguments[4][6][0].apply(a,arguments)},{dup:6}],135:[function(b,c,a){arguments[4][7][0].apply(a,arguments)
},{dup:7}],136:[function(b,c,a){arguments[4][8][0].apply(a,arguments)},{dup:8}],137:[function(c,d,a){d.exports=function b(f){f=f||window.event;
if(f.preventDefault){f.preventDefault()}else{f.returnValue=false}}},{}],138:[function(b,c,a){arguments[4][9][0].apply(a,arguments)
},{"./shared/getEventType":139,"./utils/removeEventListener":145,dup:9}],139:[function(b,c,a){arguments[4][10][0].apply(a,arguments)
},{"@marcom/ac-prefixer/getEventType":132,dup:10}],140:[function(d,g,b){var a=d("./stopPropagation");
var c=d("./preventDefault");g.exports=function f(h){h=h||window.event;a(h);c(h);
h.stopped=true;h.returnValue=false}},{"./preventDefault":137,"./stopPropagation":141}],141:[function(c,d,b){d.exports=function a(f){f=f||window.event;
if(f.stopPropagation){f.stopPropagation()}else{f.cancelBubble=true}}},{}],142:[function(b,c,a){arguments[4][74][0].apply(a,arguments)
},{dup:74}],143:[function(b,c,a){arguments[4][11][0].apply(a,arguments)},{dup:11}],144:[function(b,c,a){b("@marcom/ac-polyfills/CustomEvent");
...
if(g&&"detail" in g){f.detail=g.detail}i.fireEvent("on"+h,f)}return i}},{"@marcom/ac-polyfills/CustomEvent":104}],145:[function(b,c,a){arguments[4][12][0].apply(a,arguments)
},{dup:12}],146:[function(b,c,a){arguments[4][124][0].apply(a,arguments)},{"./ac-event-emitter/EventEmitter":147,dup:124}],147:[function(b,c,a){arguments[4][125][0].apply(a,arguments)
},{dup:125}],148:[function(d,f,c){var a=d("qs");f.exports=function b(h,g){var i=a.stringify(h,{strictNullHandling:true});
if(i&&g!==false){i="?"+i}return i}},{qs:149}],149:[function(b,d,a){var g=b("./stringify");
var c=b("./parse");var f={};d.exports={stringify:g,parse:c}},{"./parse":150,"./stringify":151}],150:[function(b,c,a){var f=b("./utils");
...
h=f.merge(h,g,p)}return f.compact(h)}},{"./utils":152}],151:[function(b,c,a){var f=b("./utils");
...
}return r.join(j)}},{"./utils":152}],152:[function(b,c,a){var f={};f.hexTable=new Array(256);
...
}},{}],153:[function(b,c,a){c.exports={clone:b("./clone"),create:b("./create"),defaults:b("./defaults"),extend:b("./extend"),getPrototypeOf:b("./getPrototypeOf"),isDate:b("./isDate"),isEmpty:b("./isEmpty"),isRegExp:b("./isRegExp"),toQueryParameters:b("./toQueryParameters")}
},{"./clone":154,"./create":155,"./defaults":156,"./extend":157,"./getPrototypeOf":158,"./isDate":159,"./isEmpty":160,"./isRegExp":161,"./toQueryParameters":162}],154:[function(c,d,b){c("@marcom/ac-polyfills/Array/isArray");
...
}return h({},j)}},{"./extend":157,"@marcom/ac-polyfills/Array/isArray":100}],155:[function(b,c,a){arguments[4][27][0].apply(a,arguments)
},{dup:27}],156:[function(b,c,a){arguments[4][89][0].apply(a,arguments)},{"./extend":157,dup:89}],157:[function(b,c,a){arguments[4][28][0].apply(a,arguments)
},{"@marcom/ac-polyfills/Array/prototype.forEach":101,dup:28}],158:[function(c,d,b){var a=Object.prototype.hasOwnProperty;
...
i.constructor=h}return g?g.prototype:null}}}}},{}],159:[function(b,d,a){d.exports=function c(f){return Object.prototype.toString.call(f)==="[object Date]"
}},{}],160:[function(c,d,b){var a=Object.prototype.hasOwnProperty;d.exports=function f(g){var h;
if(typeof g!=="object"){throw new TypeError("ac-base.Object.isEmpty : Invalid parameter - expected object")
}for(h in g){if(a.call(g,h)){return false}}return true}},{}],161:[function(c,d,b){d.exports=function a(f){return window.RegExp?f instanceof RegExp:false
}},{}],162:[function(c,f,b){var a=c("@marcom/ac-url/joinSearchParams");f.exports=function d(g){if(typeof g!=="object"){throw new TypeError("toQueryParameters error: argument is not an object")
}return a(g,false)}},{"@marcom/ac-url/joinSearchParams":148}],163:[function(b,c,a){c.exports={Routes:b("./ac-routes/Routes"),Route:b("./ac-routes/Route")}
},{"./ac-routes/Route":164,"./ac-routes/Routes":165}],164:[function(b,c,a){function f(i,k,h,j,g){this.path=i;
...
return true}}return false};c.exports=f},{}],165:[function(c,d,b){var g=c("./Route");
...
};d.exports=a},{"./Route":164}],166:[function(b,c,a){c.exports={Router:b("./ac-router/Router"),History:b("./ac-router/History"),Routes:b("@marcom/ac-routes").Routes,Route:b("@marcom/ac-routes").Route}
},{"./ac-router/History":167,"./ac-router/Router":168,"@marcom/ac-routes":163}],167:[function(c,f,b){var d=c("@marcom/ac-object").create;
...
}}return j===""?"/":j};f.exports=h},{"@marcom/ac-dom-events":131,"@marcom/ac-event-emitter":146,"@marcom/ac-object":153}],168:[function(d,c,g){var i=d("@marcom/ac-object").create;
...
};c.exports=b},{"./History":167,"@marcom/ac-dom-emitter":126,"@marcom/ac-object":153,"@marcom/ac-routes":163}],169:[function(b,c,a){var d={ua:window.navigator.userAgent,platform:window.navigator.platform,vendor:window.navigator.vendor};
c.exports=b("./parseUserAgent")(d)},{"./parseUserAgent":172}],170:[function(b,c,a){c.exports={browser:{safari:false,chrome:false,firefox:false,ie:false,opera:false,android:false,edge:false,version:{name:"",major:0,minor:0,patch:0,documentMode:false}},os:{osx:false,ios:false,android:false,windows:false,linux:false,fireos:false,chromeos:false,version:{name:"",major:0,minor:0,patch:0}}}
},{}],171:[function(b,c,a){c.exports={browser:[{name:"edge",userAgent:"Edge",version:["rv","Edge"],test:function(d){return(d.ua.indexOf("Edge")>-1||d.ua==="Mozilla/5.0 (Windows NT 10.0; Win64; x64)")
...
},{}],172:[function(b,a,d){var c=b("./defaults");var h=b("./dictionary");function g(k){return new RegExp(k+"[a-zA-Z\\s/:]+([0-9_.]+)","i")
...
return k}a.exports=i},{"./defaults":170,"./dictionary":171}],173:[function(b,c,a){arguments[4][44][0].apply(a,arguments)
},{"./../maps/focusableElement":179,dup:44}],174:[function(b,c,a){arguments[4][45][0].apply(a,arguments)
},{"./../maps/ariaMap":178,"./TabManager":173,"./setAttributes":176,dup:45}],175:[function(b,c,a){arguments[4][47][0].apply(a,arguments)
},{dup:47}],176:[function(b,c,a){arguments[4][48][0].apply(a,arguments)},{dup:48}],177:[function(b,c,a){arguments[4][49][0].apply(a,arguments)
},{"./../maps/ariaMap":178,"./removeAttributes":175,"./setAttributes":176,dup:49}],178:[function(b,c,a){arguments[4][51][0].apply(a,arguments)
},{dup:51}],179:[function(b,c,a){arguments[4][52][0].apply(a,arguments)},{dup:52}],180:[function(b,f,a){var g=b("./request/factory");
...
return c.ajax(i,j)}};f.exports=c},{"./request/factory":181}],181:[function(c,b,f){var j=c("./xmlhttprequest");
...
};b.exports=function(k,l){var m=d&&g(k)?i:j;return new m()}},{"./xdomainrequest":183,"./xmlhttprequest":184}],182:[function(b,d,a){var c=function(){};
...
}};d.exports=c},{}],183:[function(b,f,a){var d=b("./request");var c=b("@marcom/ac-object/toQueryParameters");
...
}this.xhr.send(h)};g.prototype.setTransportHeaders=function(h){};f.exports=g},{"./request":182,"@marcom/ac-object/toQueryParameters":213}],184:[function(b,d,a){var c=b("./request");
...
};d.exports=f},{"./request":182}],185:[function(c,d,b){d.exports=function a(g){if(typeof g.select==="function"){var i=false;
...
}}},{}],186:[function(b,c,a){arguments[4][3][0].apply(a,arguments)},{"./shared/getEventType":192,"./utils/addEventListener":193,dup:3}],187:[function(b,c,a){arguments[4][4][0].apply(a,arguments)
},{"./shared/camelCasedEventTypes":188,"./shared/prefixHelper":189,"./shared/windowFallbackEventTypes":190,"./utils/eventTypeAvailable":191,dup:4}],188:[function(b,c,a){arguments[4][5][0].apply(a,arguments)
},{dup:5}],189:[function(b,c,a){arguments[4][6][0].apply(a,arguments)},{dup:6}],190:[function(b,c,a){arguments[4][7][0].apply(a,arguments)
},{dup:7}],191:[function(b,c,a){arguments[4][8][0].apply(a,arguments)},{dup:8}],192:[function(b,c,a){arguments[4][10][0].apply(a,arguments)
},{"@marcom/ac-prefixer/getEventType":187,dup:10}],193:[function(b,c,a){arguments[4][11][0].apply(a,arguments)
},{dup:11}],194:[function(b,c,a){c.exports=b("./fullscreen")},{"./fullscreen":200}],195:[function(b,c,a){c.exports={STANDARD:"standard",IOS:"ios"}
},{}],196:[function(f,c,i){var h=f("@marcom/ac-dom-events/addEventListener");var l=f("@marcom/ac-event-emitter-micro").EventEmitterMicro;
...
}}}}}if(typeof n[o]==="function"){n[o].call(n)}};d.mode=b.STANDARD;c.exports=d},{"./../consts/modes":195,"./../events/types":199,"@marcom/ac-dom-events/addEventListener":186,"@marcom/ac-event-emitter-micro":33}],197:[function(c,d,a){var b=c("./ios");
...
}return g}}},{"./desktop":196,"./ios":198}],198:[function(f,d,h){var g=f("@marcom/ac-dom-events/addEventListener");
...
}};i.mode=c.IOS;d.exports=i},{"./../consts/modes":195,"./../events/types":199,"@marcom/ac-dom-events/addEventListener":186,"@marcom/ac-event-emitter-micro":33}],199:[function(b,c,a){c.exports={ENTERFULLSCREEN:"enterfullscreen",EXITFULLSCREEN:"exitfullscreen"}
},{}],200:[function(c,b,d){var i=c("@marcom/ac-event-emitter-micro").EventEmitterMicro;
...
};b.exports=g},{"./delegate/factory":197,"@marcom/ac-event-emitter-micro":33}],201:[function(b,c,a){arguments[4][11][0].apply(a,arguments)
},{dup:11}],202:[function(b,c,a){arguments[4][12][0].apply(a,arguments)},{dup:12}],203:[function(b,c,a){arguments[4][62][0].apply(a,arguments)
},{"./internal/KeyEvent":204,"@marcom/ac-dom-events/utils/addEventListener":201,"@marcom/ac-dom-events/utils/removeEventListener":202,"@marcom/ac-event-emitter-micro":33,"@marcom/ac-object/create":211,dup:62}],204:[function(b,c,a){arguments[4][64][0].apply(a,arguments)
},{dup:64}],205:[function(b,c,a){arguments[4][148][0].apply(a,arguments)},{dup:148,qs:206}],206:[function(b,c,a){arguments[4][149][0].apply(a,arguments)
},{"./parse":207,"./stringify":208,dup:149}],207:[function(b,c,a){arguments[4][150][0].apply(a,arguments)
},{"./utils":209,dup:150}],208:[function(b,c,a){arguments[4][151][0].apply(a,arguments)
},{"./utils":209,dup:151}],209:[function(b,c,a){arguments[4][152][0].apply(a,arguments)
},{dup:152}],210:[function(b,c,a){arguments[4][154][0].apply(a,arguments)},{"./extend":212,"@marcom/ac-polyfills/Array/isArray":100,dup:154}],211:[function(b,c,a){arguments[4][27][0].apply(a,arguments)
},{dup:27}],212:[function(b,c,a){arguments[4][28][0].apply(a,arguments)},{"@marcom/ac-polyfills/Array/prototype.forEach":101,dup:28}],213:[function(b,c,a){arguments[4][162][0].apply(a,arguments)
},{"@marcom/ac-url/joinSearchParams":205,dup:162}],214:[function(b,c,a){c.exports={getContentDimensions:b("./getContentDimensions"),getDimensions:b("./getDimensions"),getPagePosition:b("./getPagePosition"),getPercentInViewport:b("./getPercentInViewport"),getPixelsInViewport:b("./getPixelsInViewport"),getPosition:b("./getPosition"),getScrollX:b("./getScrollX"),getScrollY:b("./getScrollY"),getViewportPosition:b("./getViewportPosition"),isInViewport:b("./isInViewport")}
},{"./getContentDimensions":215,"./getDimensions":216,"./getPagePosition":217,"./getPercentInViewport":218,"./getPixelsInViewport":219,"./getPosition":220,"./getScrollX":221,"./getScrollY":222,"./getViewportPosition":223,"./isInViewport":224}],215:[function(d,f,c){var b=d("./utils/getBoundingClientRect");
f.exports=function a(g,i){var h=1;if(i){h=b(g).width/g.offsetWidth}return{width:g.scrollWidth*h,height:g.scrollHeight*h}
}},{"./utils/getBoundingClientRect":225}],216:[function(d,f,c){var b=d("./utils/getBoundingClientRect");
f.exports=function a(g,i){var h;if(i){h=b(g);return{width:h.width,height:h.height}
}return{width:g.offsetWidth,height:g.offsetHeight}}},{"./utils/getBoundingClientRect":225}],217:[function(g,h,f){var c=g("./getDimensions");
...
}},{"./getDimensions":216,"./getScrollX":221,"./getScrollY":222,"./utils/getBoundingClientRect":225}],218:[function(c,f,b){var a=c("./getDimensions");
var g=c("./getPixelsInViewport");f.exports=function d(j,k){var i=g(j,k);var h=a(j,k).height;
return(i/h)}},{"./getDimensions":216,"./getPixelsInViewport":219}],219:[function(c,d,b){var a=c("./getViewportPosition");
...
}if(g.bottom>j){i-=g.bottom-j}return i}},{"./getViewportPosition":223}],220:[function(d,f,c){var a=d("./getDimensions");
...
}return{top:k.top,right:k.left+k.width,bottom:k.top+k.height,left:k.left}}},{"./getDimensions":216,"./utils/getBoundingClientRect":225}],221:[function(b,c,a){arguments[4][77][0].apply(a,arguments)
},{dup:77}],222:[function(b,c,a){arguments[4][78][0].apply(a,arguments)},{dup:78}],223:[function(g,h,f){var i=g("./getPagePosition");
...
}},{"./getPagePosition":217,"./getScrollX":221,"./getScrollY":222,"./utils/getBoundingClientRect":225}],224:[function(b,d,a){var g=b("./getPixelsInViewport");
var c=b("./getPercentInViewport");d.exports=function f(j,k,h){var i;h=h||0;if(typeof h==="string"&&h.slice(-2)==="px"){h=parseInt(h,10);
i=g(j,k)}else{i=c(j,k)}return(i>0&&i>=h)}},{"./getPercentInViewport":218,"./getPixelsInViewport":219}],225:[function(c,d,b){d.exports=function a(f){var g=f.getBoundingClientRect();
return{top:g.top,right:g.right,bottom:g.bottom,left:g.left,width:g.width||g.right-g.left,height:g.height||g.bottom-g.top}
}},{}],226:[function(g,d,i){var m=g("@marcom/ac-event-emitter-micro");var a=g("@marcom/ac-dom-metrics");
...
};j.getClientXValue=function(x){var r=this.getClientXFromEvent(x);var y=a.getDimensions(this.thumbElement);
var z=a.getDimensions(this.runnableTrackElement);var t=r-this.runnableTrackElement.getBoundingClientRect().left-(y.width/2);
var w=z.width-y.width;var s=t/(w)*100;var u=this.calculateMaxSteps(this.getMin(),this.getMax());
...
};d.exports=h},{"@marcom/ac-dom-metrics":214,"@marcom/ac-event-emitter-micro":33,"@marcom/ac-keyboard/Keyboard":203}],227:[function(b,c,a){c.exports.Slider=b("./Slider")
},{"./Slider":226}],228:[function(b,c,a){c.exports=b("./lib/")},{"./lib/":229}],229:[function(b,c,a){arguments[4][149][0].apply(a,arguments)
},{"./parse":230,"./stringify":231,dup:149}],230:[function(b,c,a){var f=b("./utils");
...
}},{"./utils":232}],231:[function(b,c,a){var f=b("./utils");var d={delimiter:"&",indices:true};
...
l<g;++l){var k=o[l];m=m.concat(d.stringify(n[k],k,j))}return m.join(h)}},{"./utils":232}],232:[function(b,c,a){var d={};
...
}},{}],233:[function(b,c,a){c.exports={Link:b("./ac-social/Link"),Dialog:b("./ac-social/Dialog"),Focus:b("./ac-social/Focus"),Debug:b("./ac-social/Debug")}
},{"./ac-social/Debug":234,"./ac-social/Dialog":235,"./ac-social/Focus":236,"./ac-social/Link":237}],234:[function(c,d,b){var a=c("./NetworkActions");
...
return this};d.exports=new g()},{"./NetworkActions":238}],235:[function(d,f,c){var a=d("./NetworkActions");
...
return this};f.exports=new b()},{"./NetworkActions":238}],236:[function(b,c,a){c.exports=function(g){if(window.getSelection){var f=window.getSelection();
...
d.moveToElementText(g);d.select()}}}}},{}],237:[function(f,g,c){var a=f("./NetworkActions"),b=f("./network-actions/DefaultNetworkAction");
...
};h.removeType=function(){this.types[name]=null;return this};g.exports=new d()},{"./NetworkActions":238,"./network-actions/DefaultNetworkAction":239}],238:[function(d,c,g){var m=d("./network-actions/FacebookShare"),l=d("./network-actions/PinterestShare"),n=d("./network-actions/TumblrShare"),f=d("./network-actions/TwitterFavorite"),i=d("./network-actions/TwitterReply"),p=d("./network-actions/TwitterRetweet"),o=d("./network-actions/TwitterTweet"),k=d("./network-actions/WeiboShare"),b=d("./network-actions/QQWeiboShare"),j=d("./network-actions/QZoneShare"),h=d("./network-actions/RenrenShare"),a=d("./network-actions/EMailShare");
...
},{"./network-actions/EMailShare":240,"./network-actions/FacebookShare":241,"./network-actions/PinterestShare":243,"./network-actions/QQWeiboShare":244,"./network-actions/QZoneShare":245,"./network-actions/RenrenShare":246,"./network-actions/TumblrShare":247,"./network-actions/TwitterFavorite":248,"./network-actions/TwitterReply":249,"./network-actions/TwitterRetweet":250,"./network-actions/TwitterTweet":251,"./network-actions/WeiboShare":252}],239:[function(c,d,a){var f=c("./NetworkAction");
var b=function(g){return g};d.exports=new f(b,{baseLinkPath:""})},{"./NetworkAction":242}],240:[function(c,d,a){var f=c("./NetworkAction");
...
},{"./NetworkAction":242}],241:[function(c,d,a){var f=c("./NetworkAction");var b=function(g){return{u:g.url}
...
},{"./NetworkAction":242}],242:[function(c,d,b){var a=c("qs");var g;var f=function(i,h){h=h||{};
...
this._triggerDialog(h)};d.exports=f},{qs:228}],243:[function(c,d,a){var f=c("./NetworkAction");
...
},{"./NetworkAction":242}],244:[function(c,d,a){var f=c("./NetworkAction");var b=function(g){return{url:g.url,title:g.title,pic:g.media}
};d.exports=new f(b,{id:"qq-weibo-share",baseLinkPath:"http://v.t.qq.com/share/share.php",dialogDimensions:{width:658,height:506}})
},{"./NetworkAction":242}],245:[function(c,d,a){var f=c("./NetworkAction");var b=function(g){return{url:g.url,title:g.title,pics:g.media,summary:g.description}
...
},{"./NetworkAction":242}],246:[function(c,d,a){var f=c("./NetworkAction");var b=function(g){return{url:g.url,title:g.title}
...
},{"./NetworkAction":242}],247:[function(c,d,a){var f=c("./NetworkAction");var b=function(h){var g={clickthru:h.url,caption:h.description};
...
},{"./NetworkAction":242}],248:[function(c,d,a){var f=c("./NetworkAction");var b=function(h){var g={tweet_id:h.messageId};
...
},{"./NetworkAction":242}],249:[function(c,d,a){var f=c("./NetworkAction");var b=function(h){var g={in_reply_to:h.messageId};
...
},{"./NetworkAction":242}],250:[function(c,d,a){var f=c("./NetworkAction");var b=function(h){var g={tweet_id:h.messageId};
...
},{"./NetworkAction":242}],251:[function(c,d,a){var f=c("./NetworkAction");var b=function(h){var g={url:h.url,text:h.description};
...
},{"./NetworkAction":242}],252:[function(c,d,a){var f=c("./NetworkAction");var b=function(g){return{url:g.url,title:g.title,pic:g.media}
...
},{"./NetworkAction":242}],253:[function(b,c,a){c.exports=function d(h,g,f){if(!g){return h
}f=f||/{([^{}]*)}/g;return h.replace(f,function(j,i){var k=g[i];return(typeof k==="string"||typeof k==="number"||typeof k==="boolean")?k:j
})}},{}],254:[function(b,c,a){var f=function(g){this.el=g};var d=f.prototype;d.on=function(){this.el.addEventListener.apply(this.el,arguments)
...
this.el.dispatchEvent(g)};c.exports=f},{}],255:[function(b,d,a){var h=b("@marcom/ac-event-emitter-micro").EventEmitterMicro;
...
},{"@marcom/ac-event-emitter-micro":33}],256:[function(b,c,a){c.exports=b("./utils/urlOptimizer/OptimizeVideoUrl")
},{"./utils/urlOptimizer/OptimizeVideoUrl":306}],257:[function(q,c,C){var p=q("../event-emitter-shim/EventEmitterShim");
var x=q("../dom-emitter/DOMEmitterMicro");var i=q("../video/VideoFactory").create;
var B=q("@marcom/ac-useragent");var j=q("@marcom/ac-fullscreen");var l=q("../posterframe/PosterFrameFactory");
var t=q("@marcom/ac-feature/isRetina")();var k=q("@marcom/ac-feature/isDesktop")();
var s=q("@marcom/ac-feature/isHandheld")();var A=B.browser.safari&&B.os.osx;var m=B.browser.safari&&B.os.ios;
var D="user-hover";var f="mobile";var b="initial-play";var r="ac-video-live";var v=q("../ui/DefaultBreakpoints");
var o=q("@marcom/ac-console/log");var g=q("./event/EventsToForward");var z=q("./event/ReadyStateChangeEvents");
var d=q("../utils/BreakpointDetect");var h=q("../ui/KeyboardControl");var y=q("@marcom/ac-accessibility/helpers/hide");
var n=q("@marcom/ac-accessibility/helpers/show");var w=function(F){F=F||{};this.el=F.el||document.createElement("div");
this._elementEmitter=new x(this.el);this.options=F;p.call(this);this._controlsFactory=F.controlsFactory;
this._urlOptimizer=F.urlOptimizer;try{var E=window.top;this._maxWidth=F.maxWidth||Math.min((window.innerWidth||E.innerWidth),null)
}catch(G){this._maxWidth=F.maxWidth||Math.min(window.innerWidth,null)}this._lastMouseCoords={};
this.el.classList.add("ac-video-player");this._isResponsive=F.responsive;if(this._isResponsive){this._breakpointDetect=new d({el:this.el,breakpoints:v,addClass:true})
}this._isLive=F.live;if(this._isLive){this._useLiveMode()}this._videoImpl=i(F,this.el);
this._supportsInlineVideo=k||!(s&&m);this._cachedPiPMode=this.isPictureInPicture();
...
if(F.poster||typeof(F.poster)==="undefined"){this._initPoster(F.poster)}this._bindMethods();
this._addEventListeners();if(k){this._keyboardControl=new h({player:this,keyboardTarget:F.keyboardTarget})
}if(F.controls){this._initUIComponents()}if(F.parentElement){F.parentElement.appendChild(this.el)
...
};w.LOADEDMETADATA=1;w.LOADEDDATA=2;w.CANPLAY=3;w.CANPLAYTHROUGH=4;var a=p.prototype;
w.prototype=Object.create(a);var u=w.prototype;u.constructor=w;u._bindMethods=function(){this._onStart=this._onStart.bind(this);
...
this._forwardEvent=this._forwardEvent.bind(this);this._onPresentationModeChanged=this._onPresentationModeChanged.bind(this);
...
this._onMouseOut=this._onMouseOut.bind(this);this._onPlayPromiseError=this._onPlayPromiseError.bind(this)
};u._addEventListeners=function(){var F=0;var E=g.length;for(;F<E;F++){this._videoImpl.on(g[F],this._forwardEvent)
}F=0;E=z.length;for(;F<E;F++){this._videoImpl.on(z[F],this._forwardReadyStateChange)
...
if(k){j.on("enterfullscreen",this._forwardEnterFullScreenEvent);j.on("exitfullscreen",this._forwardExitFullScreenEvent);
j.on("enterfullscreen",this._forwardFullScreenChangeEvent);j.on("exitfullscreen",this._forwardFullScreenChangeEvent)
}else{if(m){this._videoImpl.on("webkitbeginfullscreen",this._forwardEnterFullScreenEvent);
...
};u._removeEventListeners=function(){var F=0;var E=g.length;for(;F<E;F++){this._videoImpl.off(g[F],this._forwardEvent)
}F=0;E=z.length;for(;F<E;F++){this._videoImpl.off(z[F],this._forwardReadyStateChange)
...
if(k){j.off("enterfullscreen",this._forwardEnterFullScreenEvent);j.off("exitfullscreen",this._forwardExitFullScreenEvent);
j.off("enterfullscreen",this._forwardFullScreenChangeEvent);j.off("exitfullscreen",this._forwardFullScreenChangeEvent)
}else{if(B.os.ios){this._videoImpl.off("webkitbeginfullscreen",this._forwardEnterFullScreenEvent);
...
}this._videoImpl.off("PlayPromiseError",this._onPlayPromiseError);clearTimeout(this._userInteractionTimeout)
};u._forwardReadyStateChange=function(){var E=this.getReadyState();if(E>this._cachedReadyState||E===0){this._cachedReadyState=E;
this.trigger("readystatechange",{readyState:E})}};u._forwardEvent=function(E){o(E.type+" time:"+this.getCurrentTime());
this.trigger(E.type)};u._forwardNamedEvent=function(E){o(E+" time:"+this.getCurrentTime());
this.trigger(E)};u._onPlayPromiseError=function(){o("play() Promise rejected, probably because the browser is blocking autoplay");
this.el.classList.add(b);this._showStartState();this.once("play",this._onPlay)};
u._onCaptionsChanged=function(E){var F=this.getVisibleTextTracks().length;if(F>0&&this._cachedVisibleTracksLength===0){this.trigger("texttrackshow")
}else{if(F===0&&this._cachedVisibleTracksLength>0){this.trigger("texttrackhide")
}}this._cachedVisibleTracksLength=F};u._onTimeUpdate=function(){this.trigger("timeupdate",{currentTime:this.getCurrentTime()})
};u.load=function(I,H,G,F){this.refreshSize();if(!Array.isArray(I)){I=[I]}if(H&&!Array.isArray(H)){H=[{src:H}]
}this._cachedReadyState=0;if(!F){F=this.options}if(this._urlOptimizer){if(!H){H=I.map(this._urlOptimizer.getCaptionsSource).filter(function(K){return(!!K)
})}var E=this.getVisibleTextTracks();if(E&&E.length&&H&&H.length){H[0].mode="showing"
}var J=F.maxWidth||this._calcMaxWidth();I=I.map(function(K){return this._urlOptimizer.getVideoSource(K,J,null,{maxWidth:this._maxWidth})
}.bind(this))}this.once("play",this._onPlay);if(this._poster){this._poster.show()
}if(this.options.autoplay&&k){this.once("loadstart",function(){this.play()}.bind(this))
...
this._useLiveMode()}this._videoImpl.load(I,H,G)};u._calcMaxWidth=function(){if(this.el.parentElement){return this.el.parentElement.clientWidth
}else{return this._maxWidth}};u._onPresentationModeChanged=function(E){this._forwardEvent(E);
var F=this.isPictureInPicture();if(this._cachedPiPMode!==F){this._cachedPiPMode=F;
o("pictureinpicture:change to "+F);this.trigger("pictureinpicture:change")}};u.appendTo=function(E){E.appendChild(this.el);
this.refreshSize()};u.getTextTracks=function(){return Array.prototype.slice.call(this._videoImpl.getTextTracks())
};u.getVisibleTextTracks=function(){var E=Array.prototype.slice.call(this._videoImpl.getTextTracks());
if(E&&E.length){E=E.filter(function(F){return F.mode==="showing"})}return E};u.getFullScreenElement=function(){if(!k){return this.getMediaElement()
}else{return this.el}};u.getFullScreenEnabled=function(){return j.fullscreenEnabled(this.getFullScreenElement())
};u.isFullscreen=function(){if(k){return j.fullscreenElement()===this.getFullScreenElement()
}else{return this._videoImpl.isFullscreen()}};u.requestFullscreen=function(){if(!this.isFullscreen()){this.trigger("fullscreen:willenter",{type:"enter"});
j.requestFullscreen(this.getFullScreenElement())}};u.exitFullscreen=function(){if(this.isFullscreen()){this.trigger("fullscreen:willexit",{type:"exit"});
j.exitFullscreen(this.getFullScreenElement())}};u.toggleFullscreen=function(){if(this.isFullscreen()){this.exitFullscreen()
}else{this.requestFullscreen()}};u._initUIComponents=function(){if(this._controlsFactory){this._instantiateDefaultCustomUIControls();
if(!k){this.controls.el.classList.add(f);this.setControls(true)}else{this.el.appendChild(this._blockade.el)
}}else{this.setControls(true)}};u._onFocusIn=function(){clearTimeout(this._focusOutTimer);
this._focusOutTimer=null;this._hasFocus=true;if(k){this._onUserInteraction()}};
u._onFocusOut=function(E){this._focusOutTimer=setTimeout(function(){if(this._hasFocus&&!this.el.contains(document.activeElement)){this._hasFocus=false;
this._hideControls()}}.bind(this),100)};u._showControls=function(){this.el.classList.remove(b);
this.el.classList.add(D)};u._hideControls=function(){this.el.classList.remove(D)
};u._onControlsReady=function(){if(!this.options.autoplay||!k){this._showStartState()
}};u._showStartState=function(){if(this.controls){this.controls.el.classList.add("start-state")
}if(!k){y(this.getMediaElement())}};u._hideStartState=function(){if(this.controls){this.controls.el.classList.remove("start-state")
}if(!k){n(this.getMediaElement())}};u._showEndState=function(){if(this.controls){if(this.controls.mainControlsElement){if(this.controls.mainControlsElement.contains(document.activeElement)){this.controls.playButtonElement.focus()
}}this.controls.el.classList.add("end-state")}y(this.getMediaElement())};u._hideEndState=function(){this.controls.el.classList.remove("end-state");
if(!k){n(this.getMediaElement())}};u._instantiateDefaultCustomUIControls=function(){this.controls=this._controlsFactory.create({player:this,basePath:this.options.localizationBasePath,readyCallback:function(){if(!this.options.autoplay||!k){this._showStartState()
}this.trigger("controlsready")}.bind(this)});if(this.controls.el.parentNode!==this.el){this.el.appendChild(this.controls.el)
}this._videoImpl.setControls(false);this._blockade=new x(document.createElement("div"));
this._blockade.el.classList.add("ac-video-blockade");if(k){this.controls.el.addEventListener("mousemove",this._onUserInteraction,true);
...
}}return this.controls};u._onClick=function(){this._hasFocus=false};u._onMouseLeave=function(E){window.clearTimeout(this._userInteractionTimeout);
this._hideControls();this._lastMouseCoords={}};u._onMouseOut=function(E){if(!this.controls.el.contains(E.target)&&E.target!==this.controls.el){this._onMouseLeave()
}};u._onUserInteraction=function(E){if(!this.getCurrentSrc()){return}this._showControls();
window.clearTimeout(this._userInteractionTimeout);this._userInteractionTimeout=window.setTimeout(function(){this._hideControls()
}.bind(this),this.options.controlsTimeoutDuration)};u._onPlay=function(){if(!A){this.once("timeupdate",this._onStart)
}else{this.once("timeupdate",this._onStart,function(){return this.getCurrentTime()>0
}.bind(this))}};u._onStart=function(){this.el.classList.add(b);if(this._poster){this._poster.hide()
}if(this.controls){this._hideStartState();this._hideEndState()}this.once("ended",this._onEnded)
};u._onEnded=function(){if(this.isFullscreen()){this.exitFullscreen()}if(this.controls){this._hideStartState();
this._showEndState()}this.once("timeupdate",this._onStart);if(this._poster){this._poster.show()
}};u._initPoster=function(E){this._poster=l({player:this,video:this._videoImpl,useNativePoster:(this.options.controls===false),is2x:t,src:E});
if(this._poster.el){this.el.appendChild(this._poster.el)}if(!this.options.autoplay){this._poster.show()
}};u._useLiveMode=function(){if(this._isLive){this.el.classList.add(r)}else{this.el.classList.remove(r)
}};u.once=function(G,J,H){if(arguments.length<3||typeof H==="object"){a.once.apply(this,arguments)
}else{var F=arguments;var I=Array.prototype.slice.call(arguments,2);var E=function(){if(I.every(function(K){return !!K()
})){F[1].apply(this,F);this.off(F[0],E)}}.bind(this);this.on(F[0],E)}};u.getMediaElement=function(){return this._videoImpl.getMediaElement()
};u.play=function(){o("play called");this._videoImpl.play()};u.pause=function(){this._videoImpl.pause()
};u.seek=function(E){this.setCurrentTime.apply(this,arguments)};u.addTextTrack=function(E){this._videoImpl.addTextTrack(E)
};u.getReadyState=function(){return this._videoImpl.getMediaElement().readyState
};u.getPreload=function(){return this._videoImpl.getPreload()};u.setPoster=function(E){this._poster.setSrc(E)
};u.getVolume=function(){return this._videoImpl.getVolume()};u.getMuted=function(){return this._videoImpl.getMuted()
};u.getCurrentTime=function(){return this._videoImpl.getCurrentTime()};u.getDuration=function(){return this._videoImpl.getDuration()
};u.getPaused=function(){return this._videoImpl.getPaused()};u.getEnded=function(){return this._videoImpl.getEnded()
};u.setCurrentTime=function(E){return this._videoImpl.setCurrentTime(E)};u.setVolume=function(E){this.trigger("uservolumechange");
return this._videoImpl.setVolume(E)};u.setMuted=function(E){this.trigger("uservolumechange");
this._videoImpl.setMuted(E)};u.setSrc=function(E){this._videoImpl.setSrc(E)};u.getCurrentSrc=function(){return this._videoImpl.getCurrentSrc()
};u.setControls=function(E){return this._videoImpl.setControls(E)};u.getMediaHeight=function(){return this._videoImpl.getMediaElement().videoHeight
};u.getMediaWidth=function(){return this._videoImpl.getMediaElement().videoWidth
};u.supportsPictureInPicture=function(){return this._videoImpl.supportsPictureInPicture()
};u.isPictureInPicture=function(){return this._videoImpl.isPictureInPicture()};
u.setPictureInPicture=function(E){return this._videoImpl.setPictureInPicture(E)
};u.supportsAirPlay=function(){return this._videoImpl.supportsAirPlay()};u.refreshSize=function(){if(this._breakpointDetect){this._breakpointDetect.refresh()
}else{this._currentBreakpoint&&this.el.classList.remove(this._currentBreakpoint.name);
this._currentBreakpoint=d.getBreakpointFromElement(this.el,v);this.el.classList.add(this._currentBreakpoint.name)
}};u.destroy=function(){this._removeEventListeners();this._videoImpl.destroy();
...
}p.prototype.destroy.call(this)};c.exports=w},{"../dom-emitter/DOMEmitterMicro":254,"../event-emitter-shim/EventEmitterShim":255,"../posterframe/PosterFrameFactory":263,"../ui/DefaultBreakpoints":272,"../ui/KeyboardControl":274,"../utils/BreakpointDetect":300,"../video/VideoFactory":308,"./event/EventsToForward":258,"./event/ReadyStateChangeEvents":259,"@marcom/ac-accessibility/helpers/hide":174,"@marcom/ac-accessibility/helpers/show":177,"@marcom/ac-console/log":32,"@marcom/ac-feature/isDesktop":36,"@marcom/ac-feature/isHandheld":37,"@marcom/ac-feature/isRetina":38,"@marcom/ac-fullscreen":194,"@marcom/ac-useragent":169}],258:[function(b,c,a){c.exports=["loadstart","progress","suspend","abort","error","emptied","stalled","play","pause","loadedmetadata","loadeddata","waiting","playing","canplay","canplaythrough","seeking","seeked","ended","ratechange","durationchange","volumechange","addtrack","change","removetrack"]
},{}],259:[function(b,c,a){c.exports=["loadstart","suspend","abort","error","emptied","stalled","loadedmetadata","loadeddata","waiting","canplay","canplaythrough"]
},{}],260:[function(d,f,b){var c=d("../Player");var g=d("@marcom/ac-feature/isDesktop")();
...
}var i=new c(h);if(h.sources&&h.sources.length){i.load(h.sources,h.textTracks,h.startTime)
}return i}},{"../../optimizeVideoUrl":256,"../../ui/ControlBar":270,"../../ui/ControlsFactory":271,"../../ui/DefaultComponents":273,"../Player":257,"@marcom/ac-feature/isDesktop":36}],261:[function(d,f,c){var b=d("./createPlayer");
...
}},{"./createPlayer":260}],262:[function(b,c,a){var h="ac-video-poster";var g="ac-video-poster-hide";
...
};f.setSrc=function(i){this._imgElement.src=i};c.exports=d},{}],263:[function(c,d,b){var f=c("./PosterFrame");
...
}else{h.video.setPoster(k)}}}}}},{"./PosterFrame":262}],264:[function(d,g,b){var c=d("@marcom/ac-ajax-xhr");
...
};h.destroy=function(){this._removeVideoListeners()};g.exports=a},{"./parseVTT":269,"@marcom/ac-ajax-xhr":180,"@marcom/ac-function/throttle":42}],265:[function(c,a,f){var m=c("../ui/factory/createComponents");
...
};a.exports=b},{"../ui/elements/Label":289,"../ui/factory/createComponents":294,"./TextTracksBehavior":264,"@marcom/ac-event-emitter-micro":33}],266:[function(d,a,f){var j=d("@marcom/ac-useragent");
...
}};var i=function(){};a.exports={create:b,add:g,get:c,getEmitter:h,destroy:i}},{"../dom-emitter/DOMEmitterMicro":254,"@marcom/ac-useragent":169}],267:[function(d,a,f){var c=d("./TextTracksDOM");
...
},{"./TextTracksDOM":265}],268:[function(c,d,b){var g=c("@marcom/ac-useragent");
...
return(h)?c("./TextTracksNative"):c("./TextTracksPolyfill")}},{"./TextTracksNative":266,"./TextTracksPolyfill":267,"@marcom/ac-useragent":169}],269:[function(b,d,a){var f=b("../utils/Time");
...
}}return k}},{"../utils/Time":301}],270:[function(d,b,g){var a=d("@marcom/ac-string/supplant");
var k=d("../utils/Time");var i=d("./localization/Localization");var n=d("./factory/createComponents");
var l="ac-video-controls";var c="control-bar-skin-default";var f=d("@marcom/ac-feature/isDesktop")();
var m=d("../utils/merge");var j=function(o){this._initialize(o)};var h=j.prototype;
h._initialize=function(o){this.el=o.element||document.createElement("div");this._basePath=o.basePath;
this.el.style.display="none";this._template=o.template||'<div class="controls-container" >\n\n\t<div class="{elementClassPrefix}-social-tray hidden"></div>\n\n\t<div class="center-button-container {elementClassPrefix}-play-pause-button-container">\n\t\t<div class="button-wrapper">\n\t\t\t<button type="button" class="ac-video-icon centered-button {elementClassPrefix}-play-pause-button {elementClassPrefix}-button no-autoplay" value="{playpause}" aria-label="{playpause}" role="button" tabindex="0"></button>\n\t\t</div>\n\t</div>\n\n\t<div class="main-controls-container" >\n\t\t<div class="main-controls">\n\t\t\t<div class="button-wrapper">\n\t\t\t\t<div class="main-controls-item controls-volume">\n\t\t\t\t\t<button type="button" class="ac-video-icon {elementClassPrefix}-toggle-mute-volume-button {elementClassPrefix}-button" value="{togglemutevolume}" aria-label="{togglemutevolume}" role="button" tabindex="0"></button>\n\t\t\t\t\t<div class="{elementClassPrefix}-volume-level-indicator" tabindex="0" aria-valuemin="0" aria-valuemax="100" min="0" max="100" aria-label="{adjustvolume}" role="slider" aria-orientation="vertical" step="10"></div>\n\t\t\t\t</div>\n\t\t\t</div>\n\n\t\t\t<div class="button-wrapper">\n\t\t\t\t<button type="button" class="ac-video-icon main-controls-item {elementClassPrefix}-text-tracks-toggle-button {elementClassPrefix}-button no-text-tracks" value="{captionscontrol}" aria-label="{captionscontrol}" role="button" tabindex="0"></button>\n\t\t\t</div>\n\n\t\t\t<div class="main-controls-item controls-progress">\n\t\t\t\t<div class="controls-progress-time controls-progress-time-1">\n\t\t\t\t\t<div class="{elementClassPrefix}-elapsed-time-indicator" role="text" tabindex="-1">\n\t\t\t\t\t\t<span class="label">{elapsed}</span>\n\t\t\t\t\t\t<span class="{elementClassPrefix}-elapsed-time">00:00</span>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class="controls-progress-bar">\n\t\t\t\t\t<div class="{elementClassPrefix}-buffered-indicator"></div>\n\t\t\t\t\t<div class="{elementClassPrefix}-progress-indicator ac-slider-inactive" aria-label="progress-indicator" role="slider" precision="float" min="0" max="{max}" step="1" value="0" tabindex="0" aria-valuemax="{max}" aria-valuemin="{min}" aria-valuenow="{value}"></div>\n\t\t\t\t</div>\n\t\t\t\t<div class="controls-progress-time controls-progress-time-2">\n\t\t\t\t\t<div class="{elementClassPrefix}-remaining-time-indicator" role="text" tabindex="-1">\n\t\t\t\t\t\t<span class="label">{remaining}</span>\n\t\t\t\t\t\t<span class="{elementClassPrefix}-remaining-time">-00:00</span>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t\n\t\t\t<div class="main-controls-item live-stream">\n\t\t\t\t<span class="live-stream-text">{livestream}</span>\n\t\t\t</div>\n\n\t\t\t<div class="button-wrapper">\n\t\t\t\t<button type="button" class="ac-video-icon main-controls-item {elementClassPrefix}-airplay-button {elementClassPrefix}-button airplay-unsupported" value="{airplay}" aria-label="{airplay}" role="button" tabindex="0"></button>\n\t\t\t</div>\n\n\t\t\t<div class="button-wrapper">\n\t\t\t\t<button type="button" class="ac-video-icon main-controls-item {elementClassPrefix}-picture-in-picture-button {elementClassPrefix}-button picture-in-picture-unsupported" value="{pictureinpicture}" aria-label="{pictureinpicture}" role="button" tabindex="0"></button>\n\t\t\t</div>\n\n\t\t\t<div class="button-wrapper">\n\t\t\t\t<button type="button" class="ac-video-icon main-controls-item {elementClassPrefix}-full-screen-button {elementClassPrefix}-button fullscreen-unsupported" value="{fullscreen}" aria-label="{fullscreen}" role="button" tabindex="0"></button>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>\n';
this._templateData=o.templateData||Object.assign({elementClassPrefix:"controls"});
this._destroyed=false;this._localize().then(function(){if(!this._destroyed){this._initUIComponents(o);
this.el.style.display=""}if(typeof o.readyCallback==="function"){o.readyCallback()
}}.bind(this))};h._localize=function(){return new Promise(function(o){i.getTranslation({callback:function(p){o(p)
}.bind(this),basePath:this._basePath})}.bind(this)).then(function(o){this._templateData=Object.assign(this._templateData,o)
}.bind(this))};h._renderTemplateMarkup=function(){var o=a(this._template,this._templateData);
this.el.innerHTML=o};h._initDesktopControls=function(o,p){this._componentCollection=n(o,m(p,{elementClassPrefix:this._templateData.elementClassPrefix,elapsedTimeIndicator:{behavior:{observe:{source:this._player,events:["timeupdate","seeking","seeked","durationchange"],update:function(q){q.setText(k.formatTime(this._player.getCurrentTime(),this._player.getDuration()))
}.bind(this)}}},remainingTimeIndicator:{behavior:{observe:{source:this._player,events:["timeupdate","seeking","seeked","durationchange"],update:function(q){q.setText(k.formatTime(this._player.getCurrentTime()-this._player.getDuration(),this._player.getDuration()))
...
};h._initUIComponents=function(p){this._player=p.player;var o=this.el;var q=p.components;
o.classList.add(p.className||l);this._renderTemplateMarkup();var r=o.querySelector(".main-controls-container");
if(!f){r.parentElement.removeChild(r)}else{r.classList.add(c);this.mainControlsElement=r
}this._initDesktopControls(o,q);this.sharingModule=this._componentCollection.components.socialShare[0].behavior.sharingModule;
this.playButtonElement=this.el.querySelector(".controls-play-pause-button")};h._setVolume=function(o){if(o){this._player.setMuted(false)
}this._player.setVolume(o)};h._thirySecondsBack=function(){var p=this._player.getCurrentTime();
var o=p-30;this._player.setCurrentTime((o<0)?0:o)};h.destroy=function(){if(this._componentCollection){this._componentCollection.destroy();
this._componentCollection=null}this._destroyed=true;this._player=null;this._templateData=null
};b.exports=j},{"../utils/Time":301,"../utils/merge":302,"./factory/createComponents":294,"./localization/Localization":297,"@marcom/ac-feature/isDesktop":36,"@marcom/ac-string/supplant":253}],271:[function(c,f,b){var d={components:c("./DefaultComponents"),controlsImplementation:c("./ControlBar")};
...
};f.exports=a},{"./ControlBar":270,"./DefaultComponents":273}],272:[function(b,c,a){c.exports=[{name:"small",minWidth:0,maxWidth:479},{name:"medium",minWidth:480,maxWidth:779},{name:"large",minWidth:780,maxWidth:Infinity}]
},{}],273:[function(i,a,t){var m=i("./elements/Button");var l=i("./elements/StatefulButton");
...
},{"./behaviors/AirPlayButtonBehavior":275,"./behaviors/CaptionsButtonBehavior":278,"./behaviors/FullScreenButtonBehavior":279,"./behaviors/MuteButtonBehavior":280,"./behaviors/PictureInPictureButtonBehavior":281,"./behaviors/PlayPauseButtonBehavior":282,"./behaviors/ProgressBarSliderBehavior":283,"./behaviors/SharingButtonBehavior":284,"./behaviors/SocialContainerBehavior":285,"./behaviors/VolumeSliderBehavior":286,"./elements/Button":287,"./elements/Container":288,"./elements/Label":289,"./elements/Slider":290,"./elements/StatefulButton":291,"./elements/mixins/CursorPointer":292}],274:[function(f,c,g){var b=f("@marcom/ac-keyboard/Keyboard");
...
}else{if(o>=20){this._interval=5}else{this._interval=1}}};h._onLeftArrow=function(){var o=this._player.getCurrentTime();
if(!isNaN(o)){this._player.seek(Math.max(o-this._interval,0))}};h._onRightArrow=function(){var o=this._player.getCurrentTime();
if(!isNaN(o)){this._player.seek(Math.min(o+this._interval,this._player.getDuration()))
}};h._onUpArrow=function(){var o=this._player.getMuted()?0:this._player.getVolume();
var p=Math.min(1,o+0.1);this._player.setVolume(p);this._player.setMuted(false)};
h._onDownArrow=function(){var o=this._player.getMuted()?0:this._player.getVolume();
var p=Math.max(0,o-0.1);this._player.setVolume(p);this._player.setMuted(Math.round(p*10)===0)
...
this._keyboard.destroy();l.destroy.call(this)};c.exports=a},{"@marcom/ac-event-emitter-micro":33,"@marcom/ac-keyboard/Keyboard":203}],275:[function(b,g,a){var f=b("./ButtonBehavior");
...
};g.exports=d},{"./ButtonBehavior":277}],276:[function(c,d,b){var a=function(f,g){this._player=g.player;
this._view=f;if(this._addViewListeners){this._addViewListeners()}if(this._addPlayerListeners){this._addPlayerListeners()
}};d.exports=a},{}],277:[function(b,f,a){var d=b("./BaseBehavior");var c=function(h,i){this._onClick=this._onClick.bind(this);
...
g.destroy=function(){this._view.off("click",this._onClick)};f.exports=c},{"./BaseBehavior":276}],278:[function(b,f,a){var d=b("./ButtonBehavior");
...
},{"./ButtonBehavior":277}],279:[function(b,g,a){var f=b("./ButtonBehavior");var d=function(i,j){f.apply(this,arguments);
...
c.destroy.call(this)};g.exports=d},{"./ButtonBehavior":277}],280:[function(b,f,a){var d=b("./ButtonBehavior");
var h=function(i,j){d.apply(this,arguments);this._updateState()};var c=d.prototype;
...
};f.exports=h},{"./ButtonBehavior":277}],281:[function(b,g,a){var f=b("./ButtonBehavior");
...
c.destroy.call(this)};g.exports=d},{"./ButtonBehavior":277}],282:[function(b,f,a){var d=b("./ButtonBehavior");
...
},{"./ButtonBehavior":277}],283:[function(b,d,a){var c=b("./BaseBehavior");var h=b("@marcom/ac-string/supplant");
var g=function(i,j){c.apply(this,arguments);this._visible=false;this._ariaTextTemplate=j.localization.currenttimetext;
this._onDurationChange()};var f=g.prototype=Object.create(c.prototype);f._addViewListeners=function(){this._onSliderGrab=this._onSliderGrab.bind(this);
...
this._setPlayerCurrentTime(i);this._setAriaValueText(i);this._updateScrubbedValue()
};f._onTimeUpdate=function(){if(!this._isSeeking){this._updateSliderPosition(this._player.getCurrentTime())
}};f._updateSliderPosition=function(i){this._view.setValue(i);this._setAriaValueText(i);
this._updateScrubbedValue();if(!this._visible&&!isNaN(this._player.getDuration())){this._view.show();
this._visible=true}};f._setAriaValueText=function(i){var j=Math.floor(i/60);var k=Math.ceil(i%60);
this._view.setAriaValueText(h(this._ariaTextTemplate,{minutes:j,seconds:k}))};f._updateScrubbedValue=function(){this._view.setScrubbedValue()
};f._setPlayerCurrentTime=function(i){this._player.setCurrentTime(i)};f._removeEventListeners=function(){this._player.off("durationchange",this._onDurationChange);
...
};f.destroy=function(){this._removeEventListeners()};d.exports=g},{"./BaseBehavior":276,"@marcom/ac-string/supplant":253}],284:[function(c,g,b){var f=c("./ButtonBehavior");
...
d.destroy.call(this)};g.exports=a},{"./ButtonBehavior":277}],285:[function(c,f,b){var a=c("./BaseBehavior");
...
this._view.el.appendChild(this.sharingModule.el)};f.exports=h},{"../sharing/SharingModule":299,"./BaseBehavior":276}],286:[function(b,d,a){var c=b("./BaseBehavior");
...
};d.exports=f},{"./BaseBehavior":276}],287:[function(c,d,b){var f=c("../../dom-emitter/DOMEmitterMicro");
var a=function(g){this.el=g};a.prototype=Object.create(f.prototype);d.exports=a
},{"../../dom-emitter/DOMEmitterMicro":254}],288:[function(c,d,b){var a=function(g){this.el=g
};var f=a.prototype;f.show=function(){this.el.classList.remove("hidden")};f.hide=function(){this.el.classList.add("hidden")
};d.exports=a},{}],289:[function(b,c,a){var f=function(g){this.el=g};var d=f.prototype;
d.setText=function(g){this.el.innerHTML=g};c.exports=f},{}],290:[function(b,c,a){var f=b("@marcom/ac-slider").Slider;
...
this._onFocusChange=this._onFocusChange.bind(this);this._slider.el.addEventListener("blur",this._onFocusChange);
this._slider.el.addEventListener("focus",this._onFocusChange);this._slider.el.addEventListener("mouseout",this._onFocusChange);
...
this._scrubbedEl=this.el.querySelector(".ac-slider-scrubbed");if(j.value){requestAnimationFrame(function(){if(this._slider){this.setValue(j.value)
...
this._slider.setMax(i)};g._onFocusChange=function(){setTimeout(function(){this.trigger("focuschange")
...
}else{this._scrubbedEl.style.bottom=this._slider.thumbElement.style.bottom}};g.show=function(){this.el.classList.remove(h)
};g.hide=function(){this.el.classList.add(h)};g.destroy=function(){this._slider.off("grab",this.forceCursorPointer);
this._slider.off("release",this.disableForcedCursorPointer);this._slider.destroy();
this._slider=null};c.exports=d},{"@marcom/ac-slider":227}],291:[function(c,d,b){var a=c("./Button");
...
}};d.exports=g},{"./Button":287}],292:[function(b,c,a){var d="cursor-pointer";c.exports={disableForcedCursorPointer:function(){document.body.classList.remove(d);
...
},preventDefault:function(f){f.preventDefault()}}},{}],293:[function(c,d,b){var a=function(i,k,j){return new k.classDef(i,Object.assign(k.options||{},j||{}))
...
}else{return h(i,k,j)}}},{}],294:[function(d,b,g){var f=d("./createView");var c=d("./createBehavior");
...
},{"./DefaultLabelStrings":296,"./Translations":298,"@marcom/ac-ajax-xhr":180}],298:[function(b,c,a){c.exports={"bg-BG":"bg-BG.json","cs-CZ":"cs-CZ.json","el-GR":"el-GR.json","de-AT":"de-AT.json","de-CH":"de-CH.json","de-DE":"de-DE.json","de-LI":"de-LI.json","da-DK":"da-DK.json",en:"en.json","en-US":"en-US.json","en-AP":"en-AP.json","en-CA":"en-CA.json","en-GB":"en-GB.json","en-HK":"en-HK.json","en-IE":"en-IE.json","en-IN":"en-IN.json","en-KR":"en-KR.json","en-AU":"en-AU.json","en-NZ":"en-NZ.json","en-SG":"en-SG.json","en-ZA":"en-ZA.json",es:"es.json","es-LA":"es-LA.json","es-MX":"es-MX.json","es-ES":"es-ES.json","et-EE":"et-EE.json","fi-FI":"fi-FI.json",fr:"fr.json","fr-BE":"fr-BE.json","fr-CA":"fr-CA.json","fr-CH":"fr-CH.json","fr-FR":"fr-FR.json","hr-HR":"hr-HR.json","hu-HU":"hu-HU.json","it-IT":"it-IT.json",ja:"ja.json","ja-JP":"ja-JP.json","ko-KR":"ko-KR.json","lt-LT":"lt-LT.json","lv-LV":"lv-LV.json","nl-BE":"nl-BE.json","nl-NL":"nl-NL.json","no-NO":"no-NO.json","pl-PL":"pl-PL.json",pt:"pt.json","pt-BR":"pt-BR.json","pt-PT":"pt-PT.json","ro-RO":"ro-RO.json","ru-RU":"ru-RU.json","sk-SK":"sk-SK.json","sv-SE":"sv-SE.json","tr-TR":"tr-TR.json",zh:"zh.json","zh-CN":"zh-CN.json","zh-HK":"zh-HK.json","zh-TW":"zh-TW.json"}
},{}],299:[function(b,c,a){(function(f){var n=f("","base64").toString();
...
}.bind(this))};c.exports=i}).call(this,b("buffer").Buffer)},{"../localization/Localization":297,"@marcom/ac-accessibility/helpers/TabManager":173,"@marcom/ac-analytics-share/factory/create":30,"@marcom/ac-clipboard/select":185,"@marcom/ac-console/log":32,"@marcom/ac-social":233,"@marcom/ac-string/supplant":253,"@marcom/ac-useragent":169,buffer:309}],300:[function(b,d,a){var h=b("@marcom/ac-event-emitter-micro").EventEmitterMicro;
...
},{"@marcom/ac-event-emitter-micro":33}],301:[function(b,c,a){var f=b("@marcom/ac-string/supplant");
...
}else{i+=parseFloat(g.shift())}}}return i}};c.exports=d},{"@marcom/ac-string/supplant":253}],302:[function(b,c,a){var f=b("@marcom/ac-object/clone");
...
}else{return g}};c.exports=d},{"@marcom/ac-object/clone":210}],303:[function(b,c,a){c.exports=[{width:384,height:160,type:"baseline-high",suffix:"h"},{width:384,height:160,type:"small",suffix:"h"},{width:384,height:160,type:"baseline-low",suffix:"l"},{width:384,height:160,type:"baseline-medium",suffix:"m"},{width:480,height:200,type:"medium",suffix:"h"},{width:768,height:320,type:"large",suffix:""},{width:960,height:400,type:"large",suffix:""},{width:1536,height:640,type:"large",suffix:"h"},{width:1536,height:640,type:"large",suffix:"l"},{width:1920,height:800,type:"large",suffix:"l"},{width:1920,height:800,type:"large",suffix:"h"}]
},{}],304:[function(b,c,a){c.exports=[{width:416,height:234,type:"baseline-high",suffix:"h"},{width:416,height:234,type:"small",suffix:"h"},{width:416,height:234,type:"baseline-low",suffix:"l"},{width:416,height:234,type:"baseline-medium",suffix:"m"},{width:640,height:360,type:"medium",suffix:"h"},{width:848,height:480,type:"large",suffix:""},{width:960,height:540,type:"large",suffix:""},{width:1280,height:720,type:"large",suffix:"h"},{width:1280,height:720,type:"large",suffix:"l"},{width:1920,height:1080,type:"large",suffix:"l"},{width:1920,height:1080,type:"large",suffix:"h"}]
},{}],305:[function(b,c,a){c.exports=[{width:360,height:360,type:"baseline-high",suffix:"h"},{width:360,height:360,type:"small",suffix:"h"},{width:360,height:360,type:"baseline-low",suffix:"l"},{width:480,height:480,type:"medium",suffix:""},{width:540,height:540,type:"medium",suffix:""},{width:720,height:720,type:"large",suffix:"h"},{width:720,height:720,type:"large",suffix:"l"},{width:1080,height:1080,type:"large",suffix:"l"},{width:1080,height:1080,type:"large",suffix:"h"}]
},{}],306:[function(g,c,k){var b=g("@marcom/ac-string/supplant");var f=/_r[0-9].+\.mov$/;
var i=/_[0-9]+x[0-9].+\.mp4$/;var a=/_([0-9]+)x([0-9]+)/;var s=/-cc-[a-z].*-/;var l=/-tft-.*-/;
var d="m";var j="_{width}x{height}{suffix}."+d+"p4";var o="_{height}x{width}{suffix}."+d+"p4";
var h=g("./1X1AssetSizes");var q=g("./16X9AssetSizes");var p=g("./12X5AssetSizes");
var r=function(B,t,w,D){var C;var m;a.test(B);var u={};var x;u.width=parseInt(RegExp.$1,10);
u.height=parseInt(RegExp.$2,10);if(B.match(l)){C=p;m=1536}else{if(u.width===u.height){C=h;
m=1080}else{C=q;m=1280}}if(u.width<u.height){x=true}var A=C[0].width;var z=(D&&D.maxWidth)?Math.max(D.maxWidth,A):m;
if(!B){throw"Must provide an url to optimize"}if(t===undefined||isNaN(t)){throw"Must provide a width"
}if(w){C=C.filter(function(E){return E.type===w})}if(z<1920){C=C.filter(function(E){return E.width<=z
})}var v;if(!x){v=C.reduce(function(E,F){return Math.abs(F.width-t)<Math.abs(E.width-t)?F:E
})}else{v=C.reduce(function(E,F){return Math.abs(F.height-t)<Math.abs(E.height-t)?F:E
})}var y=j;if(x){y=o}if(B.match(i)){return B.replace(i,b(y,v))}else{if(B.match(f)){return B.replace(f,b(y,v))
}else{return B}}};var n=function(m){if(!m.match(s)){return null}if(m.match(i)){return{src:m.replace(i,"_cc.vtt"),srclang:"en"}
}else{if(m.match(f)){return{src:m.replace(f,"_cc.vtt"),srclang:"en"}}else{return null
}}};c.exports={getVideoSource:r,getCaptionsSource:n}},{"./12X5AssetSizes":303,"./16X9AssetSizes":304,"./1X1AssetSizes":305,"@marcom/ac-string/supplant":253}],307:[function(b,a,d){var g=b("../dom-emitter/DOMEmitterMicro");
...
},{"../dom-emitter/DOMEmitterMicro":254,"../texttracks/createTextTracks":268,"@marcom/ac-console/log":32}],308:[function(c,f,a){var d=c("./HTML5Video");
var b=function(){};var g=b.prototype;g.create=function(i,h){return new d(Object.assign({},i,{parentElement:h}))
};f.exports=Object.create(b.prototype)},{"./HTML5Video":307}],309:[function(aR,a2,T){
/*!
 ...
 */
"use strict";
var aF=aR("base64-js");var b=aR("ieee754");T.Buffer=aD;T.SlowBuffer=aQ;T.INSPECT_MAX_BYTES=50;
var U=2147483647;T.kMaxLength=U;aD.TYPED_ARRAY_SUPPORT=aJ();if(!aD.TYPED_ARRAY_SUPPORT&&typeof console!=="undefined"&&typeof console.error==="function"){console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.")
...
}function Z(a6){return a6!==a6}},{"base64-js":310,ieee754:311}],310:[function(g,c,k){k.byteLength=q;
...
}},{}],311:[function(b,c,a){a.read=function(n,l,h,g,q){var r,k;var j=q*8-g-1;var p=(1<<j)-1;
...
}},{}],312:[function(f,d,g){f("@marcom/ac-polyfills/Object/assign");var h="data-films-modal-link";
...
}}}}return n}d.exports=b()},{"./factory/createFilms":317,"@marcom/ac-polyfills/Object/assign":106}],313:[function(b,a,c){var h;
...
}};a.exports=k},{"@marcom/ac-analytics":"@marcom/ac-analytics","@marcom/ac-useragent":169,"@marcom/ac-video/event-emitter-shim/EventEmitterShim":255}],314:[function(c,d,b){var f=c("../windowload/windowLoad");
...
if(l&&m.id){l.createRoute(m.id,function(){f(function(){n(m,!a)})})}}},{"../touchclick/TouchClick":324,"../windowload/windowLoad":325,"@marcom/ac-useragent":169}],315:[function(l,h,n){var i=l("@marcom/ac-router").Router;
...
}},{"./bindAnchor":314,"./createClickHandler":316,"./createHandheldModalLink":318,"./createInlineLink":319,"./createModalLink":320,"@marcom/ac-feature/isHandheld":37,"@marcom/ac-router":166,"@marcom/ac-useragent":169,"@marcom/ac-video/optimizeVideoUrl":256,"@marcom/ac-video/player/factory/createShareablePlayer":261}],316:[function(d,f,c){var a="data-films-options";
...
}}},{}],317:[function(c,d,b){var g=c("./bindAnchors");var f=c("../analytics/AnalyticsTranslator");
...
i.activate()}return l}},{"../analytics/AnalyticsTranslator":313,"./bindAnchors":315}],318:[function(c,d,a){var b="ac-films-handheld-player";
...
},{}],319:[function(b,c,a){c.exports=function d(i,h){var g=h.targetElement;var f=function(j,k){i.load(j,null,0,k);
i.play()};h.playHandler=f;if(g){g.appendChild(i.el)}return{play:f,player:i}}},{}],320:[function(d,b,g){var a=d("@marcom/ac-modal").createFullViewportModal;
...
return o}},{"./link/ModalLink":321,"@marcom/ac-modal":96,"@marcom/ac-useragent":169}],321:[function(f,c,h){var k="-tft-";
...
this.modal.destroy();this.player.destroy()};c.exports=m},{"../../resize/ResizeHandler":323}],322:[function(b,c,a){b("../AutoFilms")()
},{"../AutoFilms":312}],323:[function(c,d,b){var i=/_([0-9]+)x([0-9]+)/;var g=c("@marcom/ac-useragent");
...
}this._player.refreshSize()};d.exports=h},{"@marcom/ac-useragent":169}],324:[function(b,d,a){var g=b("@marcom/ac-event-emitter-micro").EventEmitterMicro;
...
return new h({el:j})};d.exports=h},{"@marcom/ac-event-emitter-micro":33,"@marcom/ac-feature/touchAvailable":40}],325:[function(c,d,b){var a=false;
